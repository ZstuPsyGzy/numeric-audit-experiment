...
无 AI / AI 阶段使用 AB/BA。AI condition 使用 4 条 Williams 平衡拉丁方序列：
...
set size 使用 6 条完整平衡序列。阶段、condition 与 set size 顺序完整交叉，形成 `2 × 4 × 6 = 48` 个顺序组。正式编号必须使用 `P001、P002……`；`P001–P048` 恰好覆盖一轮，`P049` 开始下一轮。相同编号始终得到相同顺序。
