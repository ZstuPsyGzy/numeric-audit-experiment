...
const EXPERIMENT_VERSION = "numeric-audit-cue-validity-1.5.1";
...
const insertTrial = db.prepare(`
  INSERT OR IGNORE INTO trials (
    session_id, trial_uuid, received_at, phase, trial_index_global,
...
function exportCsv(res) {
  const rows = db.prepare(`
    SELECT
      ...
      t.trial_uuid, t.received_at, t.phase, t.trial_index_global,
      ...
      t.localization_rt_ms, t.judgment_rt_ms, t.payload_json
    FROM trials t
