...
const MAX_DISPLAY_MATRIX_SIZE = 7;
...
export class NumericAuditPlugin {
  ...
  trial(displayElement, trial) {
    ...
    matrixElement.style.setProperty("--matrix-size", String(material.matrixSize));
    ...
    const finish = (responseEndedAt = activeElapsed()) => {
      ...
      this.jsPsych.finishTrial({
        ...
        matrix_relation_pair_score: material.relationPairScore,
        matrix_swapped_pair_count: material.swappedPairCount,
        matrix_shared_digit_total: material.sharedDigitTotal,
        ...displayMetrics,
